                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextCustom(
                            text: now.hour >= 20 ? 'Good Night' : 'Good Day',
                            isTitle: true,
                            fontSize: 22,
                            fontWeight: FontWeight.w600,
                            color:
                                now.hour >= 20 ? Colors.white : Colors.black),
                        Icon(FontAwesomeIcons.solidMoon,
                            color: now.hour >= 20 ? Colors.white : Colors.amber)
                      ],
                    ),
                              ...
                              ItemMenu(
                                ...
                                onTap: () {
                                  if (!state.existAccount) {
                                    randomNumberBloc
                                        .add(GenerateRandomNumberCreateEvent());
                                    Navigator.push(
                                        context,
                                        routeFade(
                                ...
                                onTap: () {
                                  if (state.existAccount) {
                                    ...
                                    Navigator.push(
                                            ...
                                            routeFade(
                                                page:
                                                    const VerifyPasswordDeleteScreen()))
                                        .then((_) {
                                      authBloc.add(ClearAllNumbersEvent());
                                    });
                                  }
                          ...
                          ItemMenu(
                            ...
                            onTap: () {
                              Navigator.push(context,
                                  routeFade(page: const ReportProblemScreen()));
                            },
                          ),
                          ItemMenu(
                          ...
                          ItemMenu(
                            ...
                            onTap: () {
                              Navigator.push(
                                  context,
                                  routeFade(
                                      page: const GeneratePasswordScreen()));
                            },
                          ),
                        ],
                      ),
