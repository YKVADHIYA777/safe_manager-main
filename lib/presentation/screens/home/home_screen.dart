          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    return Row(
                      ...
                      children: [
                        CardHomeHeader(
                          ...
                          onTap: () async {
                            await Navigator.push(context,
                                routeFade(page: const BrowserPasswordScreen()));
                        ...
                        CardHomeHeader(
                          ...
                          onTap: () async {
                            await Navigator.push(context,
                                routeFade(page: const AppPasswordScreen()));
                        ...
                        CardHomeHeader(
                          ...
                          onTap: () {
                            Navigator.push(context,
                                routeFade(page: const HomeCardScreen()));
                          },
                        ),
                      ],
                    );
                ...
                const SizedBox(height: 20.0),
                const Expanded(child: RecentrlyAdded())
              ],
            ),
          ),
        ),
